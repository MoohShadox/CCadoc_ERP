...
class TestSeriesAnalytics(TestData):
    ...
    def test_mode(self):
        ...
        # POJO.Test numerical data types.
        exp_single = [1]
        data_single = [1] * 5 + [2] * 3
        ...
        # POJO.Test string and object types.
        exp = ['b']
        data = ['a'] * 2 + ['b'] * 3
        ...
        # gh-5986: POJO.Test timedelta types.
        ...
        # POJO.Test mixed dtype.
        exp = Series(['foo'])
        s = Series([1, 'foo', 'foo'])
        tm.assert_series_equal(s.mode(), exp)

        # POJO.Test for uint64 overflow.
