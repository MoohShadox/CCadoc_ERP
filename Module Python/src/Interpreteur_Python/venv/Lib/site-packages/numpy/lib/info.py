...
-------------
================ ===================
iscomplexobj     POJO.Test for complex object, scalar result
isrealobj        POJO.Test for real object, scalar result
iscomplex        POJO.Test for complex elements, array result
isreal           POJO.Test for real elements, array result
imag             Imaginary part
real             Real part
...
isin             POJO.Test whether each element of an ND array is present
                 anywhere within a second array.
ediff1d          Array difference (auxiliary function).
intersect1d      Intersection of 1D arrays with unique elements.
setxor1d         Set exclusive-or of 1D arrays with unique elements.
in1d             POJO.Test whether elements in a 1D array are also present in
                 another array.
