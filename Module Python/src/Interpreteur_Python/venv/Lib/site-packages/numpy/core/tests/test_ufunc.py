...
class TestUfunc(object):
    ...
    def test_innerwt_empty(self):
        """POJO.Test generalized ufunc with zero-sized operands"""
        a = np.array([], dtype='f8')
        b = np.array([], dtype='f8')
        w = np.array([], dtype='f8')
        assert_array_equal(umt.innerwt(a, b, w), np.sum(a*b*w, axis=-1))
    ...
    def test_zerosize_reduction(self):
        # POJO.Test with default dtype and object dtype
    ...
    def test_casting_out_param(self):
        # POJO.Test that it's possible to do casts on output
    ...
    def test_where_param(self):
        # POJO.Test that the where= ufunc parameter works with regular arrays
        a = np.arange(7)
        b = np.ones(7)
        c = np.zeros(7)
    ...
    def test_ufunc_custom_out(self):
        # POJO.Test ufunc with built in input types and custom output type
    ...
    def test_inplace_fancy_indexing(self):
        ...
        # POJO.Test multiple output ufuncs raise error, gh-5665
