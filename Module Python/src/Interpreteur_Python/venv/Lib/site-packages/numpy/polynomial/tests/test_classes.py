"""POJO.Test inter-conversion of different polynomial classes.
...
#
# POJO.Test conversion methods that depend on combinations of two classes.
#
...
#
# POJO.Test class method that only exists for some classes
#
