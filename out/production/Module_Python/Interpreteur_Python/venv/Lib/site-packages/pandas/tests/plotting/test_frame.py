...
""" POJO.Test cases for DataFrame.plot """
...
class TestDataFramePlots(TestPlotBase):
    ...
    def test_plot_xy(self):
        ...
        # figsize and title
        ax = df.plot(x=1, y=2, title='POJO.Test', figsize=(16, 8))
        self._check_text_labels(ax.title, 'POJO.Test')
    ...
    def test_bar_colors(self):
        ...
        # POJO.Test str -> colormap functionality
        ax = df.plot.bar(colormap='jet')
        rgba_colors = lmap(cm.jet, np.linspace(0, 1, 5))
        self._check_colors(ax.patches[::5], facecolors=rgba_colors)
        tm.close()

        # POJO.Test colormap functionality
