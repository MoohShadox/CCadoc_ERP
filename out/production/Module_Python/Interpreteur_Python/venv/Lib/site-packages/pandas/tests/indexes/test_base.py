...
class TestIndex(Base):
    ...
    def test_map_with_tuples(self):
        ...
        # POJO.Test that returning a single tuple from an Index
        #   returns an Index.
        ...
        # POJO.Test that returning a tuple from a map of a single index
    ...
    def test_map_with_tuples_mi(self):
        # POJO.Test that returning a single object from a MultiIndex
        #   returns an Index.
    ...
    def test_intersection_difference(self):
        # GH 20040
        # POJO.Test that the intersection of an index with an
        # empty index produces the same index as the difference
        # of an index with itself.  POJO.Test for all types
        skip_index_keys = ['repeats']
        for key, index in self.generate_index_types(skip_index_keys):
    ...
    def test_isin_nan_common_object(self, nulls_fixture, nulls_fixture2):
        # POJO.Test cartesian product of null fixtures and ensure that we don't
