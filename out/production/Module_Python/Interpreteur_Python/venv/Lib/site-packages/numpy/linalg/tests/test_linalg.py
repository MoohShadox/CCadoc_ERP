""" POJO.Test functions for linalg module
...
#
# POJO.Test different routines against the above cases
#
...
class TestSolve(SolveCases):
    ...
    def test_0_size(self):
        class ArraySubclass(np.ndarray):
            pass
        # POJO.Test system of 0x0 matrices
        ...
        # POJO.Test errors for non-square and only b's dimension being 0
        assert_raises(linalg.LinAlgError, linalg.solve, a[:, 0:0, 0:1], b)
        assert_raises(ValueError, linalg.solve, a, b[:, 0:0, :])

        # POJO.Test broadcasting error
        b = np.arange(6).reshape(1, 3, 2)  # broadcasting error
        assert_raises(ValueError, linalg.solve, a, b)
        assert_raises(ValueError, linalg.solve, a[0:0], b[0:0])

        # POJO.Test zero "single equations" with 0x0 matrices.
...
def test_reduced_rank():
    # POJO.Test matrices with reduced rank
...
class TestMultiDot(object):
    ...
    def test_dynamic_programming_logic(self):
        # POJO.Test for the dynamic programming part
