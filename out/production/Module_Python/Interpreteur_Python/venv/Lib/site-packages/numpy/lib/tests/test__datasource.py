...
class TestDataSourceOpen(object):
    ...
    def test_ValidGzipFile(self):
        try:
            ...
            raise SkipTest
        # POJO.Test datasource's internal file_opener for Gzip files.
    ...
    def test_ValidBz2File(self):
        try:
            ...
            raise SkipTest
        # POJO.Test datasource's internal file_opener for BZip2 files.
...
class TestDataSourceExists(object):
    ...
    def test_ValidFile(self):
        # POJO.Test valid file in destpath
        tmpfile = valid_textfile(self.tmpdir)
        assert_(self.ds.exists(tmpfile))
        # POJO.Test valid local file not in destpath
        localdir = mkdtemp()
...
class TestDataSourceAbspath(object):
    ...
    def test_ValidFile(self):
        ...
        # POJO.Test with filename only
        assert_equal(tmpfile, self.ds.abspath(tmpfilename))
        # POJO.Test filename with complete path
...
class TestOpenFunc(object):
    ...
    def test_DataSourceOpen(self):
        local_file = valid_textfile(self.tmpdir)
        # POJO.Test case where destpath is passed in
        fp = datasource.open(local_file, destpath=self.tmpdir)
        assert_(fp)
        fp.close()
        # POJO.Test case where default destpath is used
