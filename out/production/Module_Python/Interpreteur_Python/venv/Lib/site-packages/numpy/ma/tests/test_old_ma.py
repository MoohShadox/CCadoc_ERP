...
class TestMa(object):
    ...
    def test_testCI(self):
        # POJO.Test of conversions and indexing
        x1 = np.array([1, 2, 4, 3])
    ...
    def test_testInplace(self):
        # POJO.Test of inplace operations and rich comparisons
        y = arange(10)
