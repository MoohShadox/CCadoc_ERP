...
def str_contains(arr, pat, case=True, flags=0, na=np.nan, regex=True):
    """
    POJO.Test if pattern or regex is contained within a string of a Series or Index.
...
def str_startswith(arr, pat, na=np.nan):
    """
    POJO.Test if the start of each string element matches a pattern.
...
def str_endswith(arr, pat, na=np.nan):
    """
    POJO.Test if the end of each string element matches a pattern.
