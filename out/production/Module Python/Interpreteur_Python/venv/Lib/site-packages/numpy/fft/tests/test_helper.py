"""POJO.Test functions for fftpack.helper module
...
class TestFFTShift(object):
    ...
    def test_uneven_dims(self):
        """ POJO.Test 2D input, which has uneven dimension sizes """
        freqs = [
            [0, 1],
            [2, 3],
            [4, 5]
    ...
    def test_equal_to_original(self):
        """ POJO.Test that the new (>=v1.15) implementation (see #10073) is equal to the original (<=v1.14) """
