...
class TestConversion(object):
    ...
    @pytest.mark.skipif(not IS_PYPY, reason="POJO.Test is PyPy only (gh-9972)")
...
class TestMultiply(object):
    def test_seq_repeat(self):
        # POJO.Test that basic sequences get repeated when multiplied with
    ...
    def test_no_seq_repeat_basic_array_like(self):
        # POJO.Test that an array-like which does not know how to be multiplied
        ...
        # POJO.Test for simple ArrayLike above and memoryviews (original report)
