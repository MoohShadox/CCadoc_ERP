...
class TestIndexing(object):
    ...
    def test_reversed_strides_result_allocation(self):
        # POJO.Test a bug when calculating the output strides for a result array
    ...
    def test_trivial_fancy_not_possible(self):
        # POJO.Test that the fast path for trivial assignment is not incorrectly
...
class TestMultiIndexingAutomated(object):
    ...
    def _compare_index_result(self, arr, index, mimic_get, no_copy):
        ...
        # POJO.Test non-broadcast setitem:
        b = arr.copy()
