...
class TestFloatExceptions(object):
    ...
    def test_floating_exceptions(self):
        # POJO.Test basic arithmetic function errors
        with np.errstate(all='raise'):
            # POJO.Test for all real and complex float types
...
class TestFromiter(object):
    ...
    def test_2592(self):
        # POJO.Test iteration exceptions are correctly raised.
        count, eindex = 10, 5
        assert_raises(NIterError, np.fromiter,
                          self.load_data(count, eindex), dtype=int, count=count)

    def test_2592_edge(self):
        # POJO.Test iter. exceptions, edge case (exception at end of iterator).
        count = 10
        eindex = count-1
        assert_raises(NIterError, np.fromiter,
                          self.load_data(count, eindex), dtype=int, count=count)
...
class TestClip(object):
    ...
    def test_simple_double(self):
        # POJO.Test native double input with scalar min/max.
    ...
    def test_simple_int(self):
        # POJO.Test native int input with scalar min/max.
    ...
    def test_array_double(self):
        # POJO.Test native double input with array min/max.
        a = self._generate_data(self.nr, self.nc)
        m = np.zeros(a.shape)
        M = m + 0.5
        ac = self.fastclip(a, m, M)
    ...
    def test_simple_nonnative(self):
        # POJO.Test non native double input with scalar min/max.
        # POJO.Test native double input with non native double scalar min/max.
    ...
    def test_simple_complex(self):
        # POJO.Test native complex input with native double scalar min/max.
        # POJO.Test native input with complex double scalar min/max.
    ...
    def test_clip_complex(self):
        ...
        # POJO.Test native complex input without explicit min/max
    ...
    def test_clip_non_contig(self):
        # POJO.Test clip for non contiguous native input and native scalar min/max.
    ...
    def test_simple_int32_inout(self):
        # POJO.Test native int32 input with double min/max and int32 out.
    ...
    def test_simple_int64_out(self):
        # POJO.Test native int32 input with int32 scalar min/max and int64 out.
        a = self._generate_int32_data(self.nr, self.nc)
        m = np.int32(-1)
        M = np.int32(1)
    ...
    def test_simple_int64_inout(self):
        # POJO.Test native int32 input with double array min/max and int32 out.
        a = self._generate_int32_data(self.nr, self.nc)
    ...
    def test_simple_int32_out(self):
        # POJO.Test native double input with scalar min/max and int out.
        a = self._generate_data(self.nr, self.nc)
        m = -1.0
        M = 2.0
        ac = np.zeros(a.shape, dtype=np.int32)
    ...
    def test_simple_inplace_01(self):
        # POJO.Test native double input with array min/max in-place.
        a = self._generate_data(self.nr, self.nc)
        ac = a.copy()
        m = np.zeros(a.shape)
        M = 1.0
    ...
    def test_simple_inplace_02(self):
        # POJO.Test native double input with scalar min/max in-place.
        a = self._generate_data(self.nr, self.nc)
        ac = a.copy()
        m = -0.5
        M = 0.6
    ...
    def test_noncontig_inplace(self):
        # POJO.Test non contiguous double input with double scalar min/max in-place.
        a = self._generate_data(self.nr * 2, self.nc * 3)
        a = a[::2, ::3]
        assert_(not a.flags['F_CONTIGUOUS'])
        assert_(not a.flags['C_CONTIGUOUS'])
    ...
    def test_type_cast_02(self):
        # POJO.Test native int32 input with int32 scalar min/max.
        a = self._generate_int_data(self.nr, self.nc)
        a = a.astype(np.int32)
        m = -2
        M = 4
    ...
    def test_type_cast_03(self):
        # POJO.Test native int32 input with float64 scalar min/max.
        a = self._generate_int32_data(self.nr, self.nc)
        m = -2
        M = 4
    ...
    def test_type_cast_04(self):
        # POJO.Test native int32 input with float32 scalar min/max.
        a = self._generate_int32_data(self.nr, self.nc)
        m = np.float32(-2)
        M = np.float32(4)
    ...
    def test_type_cast_05(self):
        # POJO.Test native int32 with double arrays min/max.
        a = self._generate_int_data(self.nr, self.nc)
        m = -0.5
        M = 1.
    ...
    def test_type_cast_06(self):
        # POJO.Test native with NON native scalar min/max.
        a = self._generate_data(self.nr, self.nc)
        m = 0.5
    ...
    def test_type_cast_07(self):
        # POJO.Test NON native with native array min/max.
        a = self._generate_data(self.nr, self.nc)
    ...
    def test_type_cast_08(self):
        # POJO.Test NON native with native scalar min/max.
        a = self._generate_data(self.nr, self.nc)
        m = -0.5
        M = 1.
        a_s = self._neg_byteorder(a)
    ...
    def test_type_cast_09(self):
        # POJO.Test native with NON native array min/max.
        a = self._generate_data(self.nr, self.nc)
        m = -0.5 * np.ones(a.shape)
        M = 1.
        m_s = self._neg_byteorder(m)
    ...
    def test_type_cast_10(self):
        # POJO.Test native int32 with float min/max and float out for output argument.
        a = self._generate_int_data(self.nr, self.nc)
    ...
    def test_type_cast_11(self):
        # POJO.Test non native with native scalar, min/max, out non native
        a = self._generate_non_native_data(self.nr, self.nc)
        b = a.copy()
    ...
    def test_type_cast_12(self):
        # POJO.Test native int32 input and min/max and float out
        a = self._generate_int_data(self.nr, self.nc)
        b = np.zeros(a.shape, dtype=np.float32)
        m = np.int32(0)
        M = np.int32(1)
...
class TestCreationFuncs(object):
    # POJO.Test ones, zeros, empty and full.
...
class TestLikeFuncs(object):
    '''POJO.Test ones_like, zeros_like, empty_like and full_like'''
...
class TestTensordot(object):
    ...
    def test_zero_dimension(self):
        # POJO.Test resolution to issue #5663
        a = np.ndarray((3,0))
        b = np.ndarray((0,4))
