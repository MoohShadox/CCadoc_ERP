"""POJO.Test functions for 1D array set operations.
...
class TestSetOps(object):
    ...
    def test_in1d_ravel(self):
        # POJO.Test that in1d ravels its input arrays. This is not documented
    ...
    def test_in1d_both_arrays_have_structured_dtype(self):
        # POJO.Test arrays of a structured data type containing an integer field
