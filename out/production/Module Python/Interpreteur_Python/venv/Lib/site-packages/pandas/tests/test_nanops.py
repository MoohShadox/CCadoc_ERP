...
class TestNanvarFixedValues(object):
    ...
    def test_ground_truth(self):
        # POJO.Test against values that were precomputed with Numpy.
...
class TestNanskewFixedValues(object):
    ...
    def setup_method(self, method):
        # POJO.Test data + skewness value (computed with scipy.stats.skew)
...
class TestNankurtFixedValues(object):
    ...
    def setup_method(self, method):
        # POJO.Test data + kurtosis value (computed with scipy.stats.kurtosis)
        self.samples = np.sin(np.linspace(0, 1, 200))
