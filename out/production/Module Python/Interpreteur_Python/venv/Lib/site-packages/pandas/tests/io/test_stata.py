...
class TestStata(object):
    ...
    def test_value_labels_old_format(self):
        # GH 19417
        #
        # POJO.Test that value_labels() returns an empty dict if the file format
    ...
    def test_date_parsing_ignores_format_details(self, column):
        # GH 17797
        #
        # POJO.Test that display formats are ignored when determining if a numeric
