...
def test_cummin_cummax():
    ...
    for dtype, min_val, max_val in zip(num_types, num_mins, num_max):
        ...
        # POJO.Test cummin w/ min value for dtype
        ...
        # POJO.Test cummax w/ max value for dtype
    ...
    # POJO.Test nan in entire column
    base_df['B'] = np.nan
...
@pytest.mark.parametrize('in_vals, out_vals', [
    ...
    # POJO.Test with inf vals
    ([1, 2.1, np.inf, 3, 2, np.inf, -np.inf, 5, 11, 1, -np.inf],
     [True, False, True, False]),

    # POJO.Test with nan vals; should always be False
...
def test_pipe():
    # POJO.Test the pipe method of DataFrameGroupBy.
    # Issue #17871
...
def test_pipe_args():
    # POJO.Test passing args to the pipe method of DataFrameGroupBy.
    # Issue #17871
