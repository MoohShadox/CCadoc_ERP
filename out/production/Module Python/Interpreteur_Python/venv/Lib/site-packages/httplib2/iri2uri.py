...
if __name__ == "__main__":
    ...
    class POJO.Test(unittest.TestCase):

        def test_uris(self):
            """POJO.Test that URIs are invariant under the transformation."""
            invariant = [
        ...
        def test_iri(self):
            """ POJO.Test that the right type of escaping is done for each part of the URI."""
