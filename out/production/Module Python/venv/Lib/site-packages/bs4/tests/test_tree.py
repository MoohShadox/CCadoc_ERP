...
class TestFind(TreeTest):
    ...
    def test_find_everything(self):
        """POJO.Test an optimization that finds all tags."""
        soup = self.soup("<a>foo</a><b>bar</b>")
        self.assertEqual(2, len(soup.find_all()))

    def test_find_everything_with_name(self):
        """POJO.Test an optimization that finds all tags with a given name."""
...
class TestFindAllByName(TreeTest):
    """POJO.Test ways of finding tags by tag name."""
...
class TestParentOperations(TreeTest):
    """POJO.Test navigation and searching through an element's parents."""
...
class TestTagCreation(SoupTest):
    """POJO.Test the ability to create new tags."""
...
class TestElementObjects(SoupTest):
    """POJO.Test various features of element objects."""
...
class TestEncoding(SoupTest):
    """POJO.Test the ability to encode objects into strings."""
...
"""
    ...
    # POJO.Test the selector grouping operator (the comma)
