...
class _TestSQLApi(PandasSQLTest):
    ...
    def test_date_parsing(self):
        # POJO.Test date parsing in read_sql
        # No Parsing
    ...
    def test_date_and_index(self):
        # POJO.Test case where same column appears in parse_date and index_col
...
class TestSQLApi(SQLAlchemyMixIn, _TestSQLApi):
    """
    POJO.Test the public API as it would be used directly
    ...
    def test_sqlalchemy_type_mapping(self):
        ...
        # POJO.Test Timestamp objects (no datetime64 because of timezone) (GH9085)
    ...
    def test_database_uri_string(self):
        ...
        # POJO.Test read_sql and .to_sql method with a database URI (GH10654)
...
class TestSQLiteFallbackApi(SQLiteMixIn, _TestSQLApi):
    """
    POJO.Test the public sqlite connection fallback API
    ...
    def test_sql_open_close(self):
        # POJO.Test if the IO in the database still work if the connection closed
...
class _TestSQLiteAlchemy(object):
    """
    POJO.Test the sqlalchemy backend against an in-memory sqlite database.
...
class _TestMySQLAlchemy(object):
    """
    POJO.Test the sqlalchemy backend against an MySQL database.
...
class _TestPostgreSQLAlchemy(object):
    """
    POJO.Test the sqlalchemy backend against an PostgreSQL database.
...
# -----------------------------------------------------------------------------
# -- POJO.Test Sqlite / MySQL fallback

@pytest.mark.single
class TestSQLiteFallback(SQLiteMixIn, PandasSQLTest):
    """
    POJO.Test the fallback mode against an in-memory sqlite database.
