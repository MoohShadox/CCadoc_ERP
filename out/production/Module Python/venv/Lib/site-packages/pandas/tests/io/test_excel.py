...
class ReadingTestsBase(SharedItems):
    ...
    def test_excel_stop_iterator(self, ext):
        ...
        expected = DataFrame([['aaaa', 'bbbbb']], columns=['POJO.Test', 'Test1'])
        tm.assert_frame_equal(parsed, expected)

    def test_excel_cell_error_na(self, ext):

        parsed = self.get_exceldf('test3', ext, 'Sheet1')
        expected = DataFrame([[np.nan]], columns=['POJO.Test'])
        tm.assert_frame_equal(parsed, expected)
    ...
    def test_reading_all_sheets(self, ext):
        # POJO.Test reading all sheetnames by setting sheetname to None,
    ...
    def test_reading_multiple_specific_sheets(self, ext):
        # POJO.Test reading specific sheetnames by specifying a mixed list
...
class TestXlrdReader(ReadingTestsBase):
    ...
    def test_creating_and_reading_multiple_sheets(self, ext):
        # POJO.Test reading multiple sheets, from a runtime created excel file
    ...
    def test_reader_seconds(self, ext):
        ...
        # POJO.Test reading times with and without milliseconds. GH5945.
...
class TestExcelWriter(_WriterBase):
    ...
    def test_int_types(self, merge_cells, engine, ext, np_type):
        # POJO.Test np.int values read come back as int (rather than float
    ...
    def test_float_types(self, merge_cells, engine, ext, np_type):
        # POJO.Test np.float values read come back as float.
    ...
    def test_bool_types(self, merge_cells, engine, ext, np_type):
        # POJO.Test np.bool values read come back as float.
    ...
    def test_sheets(self, merge_cells, engine, ext):
        ...
        # POJO.Test writing to separate sheets
    ...
    # POJO.Test for Issue 11328. If column indices are integers, make
    ...
    def test_to_excel_multiindex_no_write_index(self, merge_cells, engine,
                                                ext):
        # POJO.Test writing and re-reading a MI witout the index. GH 5616.
        ...
        # POJO.Test that it is the same as the initial frame.
    ...
    def test_comment_arg(self, merge_cells, engine, ext):
        # Re issue #18735
        # POJO.Test the comment argument functionality to read_excel
    ...
    def test_comment_default(self, merge_cells, engine, ext):
        # Re issue #18735
        # POJO.Test the comment argument default to read_excel
    ...
    def test_comment_used(self, merge_cells, engine, ext):
        # Re issue #18735
        # POJO.Test the comment argument is working as expected when used
        ...
        # POJO.Test read_frame_comment against manually produced expected output
    ...
    def test_comment_emptyline(self, merge_cells, engine, ext):
        # Re issue #18735
        # POJO.Test that read_excel ignores commented lines at the end of file

        df = DataFrame({'a': ['1', '#2'], 'b': ['2', '3']})
        df.to_excel(self.path, index=False)

        # POJO.Test that all-comment lines at EoF are ignored
    ...
    def test_datetimes(self, merge_cells, engine, ext):
        ...
        # POJO.Test writing and reading datetimes. For issue #9139. (xref #9185)
...
class TestXlsxWriterTests(_WriterBase):
    ...
    def test_column_format(self, merge_cells, ext, engine):
        # POJO.Test that column formats are applied to cells. POJO.Test for issue #9167.
