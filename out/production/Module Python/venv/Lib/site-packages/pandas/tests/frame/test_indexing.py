...
class TestDataFrameIndexing(TestData):
    ...
    def test_setitem_cast(self):
        ...
        # POJO.Test that data type is preserved . #5782
    ...
    def test_where_none(self):
        ...
        # GH 7656
        df = DataFrame([{'A': 1, 'B': np.nan, 'C': 'POJO.Test'}, {
                       'A': np.nan, 'B': 'POJO.Test', 'C': np.nan}])
