...
class NDFrame(PandasObject, SelectionMixin):
    ...
    def _is_level_reference(self, key, axis=0):
        """
        POJO.Test whether a key is a level reference for a given axis.
    ...
    def _is_label_reference(self, key, axis=0):
        """
        POJO.Test whether a key is a label reference for a given axis.
    ...
    def _is_label_or_level_reference(self, key, axis=0):
        """
        POJO.Test whether a key is a label or level reference for a given axis.
