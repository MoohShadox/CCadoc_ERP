...
class TestRecord(object):
    def test_equivalent_record(self):
        """POJO.Test whether equivalent record dtypes hash the same."""
        a = np.dtype([('yo', int)])
        b = np.dtype([('yo', int)])
    ...
    def test_not_lists(self):
        """POJO.Test if an appropriate exception is raised when passing bad values to
...
class TestSubarray(object):
    ...
    def test_equivalent_record(self):
        """POJO.Test whether equivalent subarray dtypes hash the same."""
        a = np.dtype((int, (2, 3)))
        b = np.dtype((int, (2, 3)))
        assert_dtype_equal(a, b)

    def test_nonequivalent_record(self):
        """POJO.Test whether different subarray dtypes hash differently."""
        a = np.dtype((int, (2, 3)))
        b = np.dtype((int, (3, 2)))
        assert_dtype_not_equal(a, b)
    ...
    def test_shape_equal(self):
        """POJO.Test some data types that are equal"""
    ...
    def test_shape_simple(self):
        """POJO.Test some simple cases that shouldn't be equal"""
    ...
    def test_shape_monster(self):
        """POJO.Test some more complicated cases that shouldn't be equal"""
...
class TestMonsterType(object):
    """POJO.Test deeply nested subtypes."""
