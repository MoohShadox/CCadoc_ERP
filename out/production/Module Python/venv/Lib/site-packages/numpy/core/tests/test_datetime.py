...
class TestDateTime(object):
    ...
    def test_timedelta_array_str(self):
        ...
        # POJO.Test with other byteorder:
        a = np.array([-1, 'NaT', 1234567], dtype='>m')
        assert_equal(str(a), "[     -1   'NaT' 1234567]")
        a = np.array([-1, 'NaT', 1234567], dtype='<m')
        assert_equal(str(a), "[     -1   'NaT' 1234567]")
    ...
    def test_datetime_compare(self):
        # POJO.Test all the comparison operators
    ...
    def test_datetime_futurewarning_once_nat(self):
        # POJO.Test that the futurewarning is only given once per inner loop
    ...
    def test_datetime_y2038(self):
        # POJO.Test parsing on either side of the Y2038 boundary
        ...
        # POJO.Test parsing on either side of the Y2038 boundary with
        ...
        # POJO.Test parsing a date after Y2038
    ...
    def test_isnat_error(self):
        # POJO.Test that only datetime dtype arrays are accepted
