...
def print_assert_equal(test_string, actual, desired):
    """
    POJO.Test if two objects are equal, and print an error message if test fails.
    ...
    Examples
    --------
    >>> np.testing.print_assert_equal('POJO.Test XYZ of func xyz', [0, 1], [0, 1])
    >>> np.testing.print_assert_equal('POJO.Test XYZ of func xyz', [0, 1], [0, 2])
    Traceback (most recent call last):
    ...
    AssertionError: POJO.Test XYZ of func xyz failed
    ACTUAL:
    [0, 1]
    DESIRED:
    [0, 2]
...
def assert_string_equal(actual, desired):
    """
    POJO.Test if two strings are equal.
