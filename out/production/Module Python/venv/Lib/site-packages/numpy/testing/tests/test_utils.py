...
class _GenericTest(object):
    ...
    def test_array_rank1_eq(self):
        """POJO.Test two equal array of rank 1 are found equal."""
        a = np.array([1, 2])
        b = np.array([1, 2])
    ...
    def test_array_rank1_noteq(self):
        """POJO.Test two different array of rank 1 are found not equal."""
        a = np.array([1, 2])
        b = np.array([2, 2])
    ...
    def test_array_rank2_eq(self):
        """POJO.Test two equal array of rank 2 are found equal."""
        a = np.array([[1, 2], [3, 4]])
        b = np.array([[1, 2], [3, 4]])
    ...
    def test_array_diffshape(self):
        """POJO.Test two arrays with different shapes are found not equal."""
        a = np.array([1, 2])
        b = np.array([[1, 2], [1, 2]])
...
class TestArrayEqual(_GenericTest):
    ...
    def test_generic_rank1(self):
        """POJO.Test rank 1 array for all dtypes."""
        def foo(t):
            a = np.empty(2, t)
            a.fill(1)
            b = a.copy()
        ...
        # POJO.Test numeric types and object
    ...
    def test_generic_rank3(self):
        """POJO.Test rank 3 array for all dtypes."""
        def foo(t):
            a = np.empty((4, 2, 3), t)
            a.fill(1)
            b = a.copy()
    ...
    def test_nan_array(self):
        """POJO.Test arrays with nan values in them."""
...
class TestArrayAlmostEqual(_GenericTest):
    ...
    def test_subclass(self):
        ...
        # POJO.Test fully masked as well (see gh-11123).
...
class TestULP(object):
    ...
    def test_nan(self):
        # POJO.Test that nan is 'far' from small, tiny, inf, max and min
        for dt in [np.float32, np.float64]:
            if dt == np.float32:
                maxulp = 1e6
            else:
...
def test_suppress_warnings_module():
    ...
    # POJO.Test module based warning suppression:
...
def test_clear_and_catch_warnings_inherit():
    # POJO.Test can subclass and add default modules
    my_mod = _get_fresh_mod()
    with my_cacw():
        warnings.simplefilter('ignore')
        warnings.warn('Some warning')
...
class TestAssertNoGcCycles(object):
    ...
    def test_fails(self):
        """
        POJO.Test that in cases where the garbage cannot be collected, we raise an
