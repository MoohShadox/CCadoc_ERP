...
# doctest
r''' POJO.Test the .npy file format.
...
POJO.Test the magic string writing.
...
POJO.Test the magic string reading.
...
def test_pickle_python2_python3():
    # POJO.Test that loading object arrays saved on Python 2 works both on
